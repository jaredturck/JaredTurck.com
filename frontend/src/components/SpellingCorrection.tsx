import spelling_img from '../imgs/spelling_correction_qwen.png'
        ...
        <div className='grid gap-10 px-6 py-10 lg:grid-cols-2 lg:items-center'>
          <div className='flex flex-col gap-5'>
            ...
            <p className='m-0 max-w-xl text-base leading-relaxed text-muted sm:text-lg'>
              A fine-tuned Qwen3 model for spelling correction that uses sentence context to identify and correct misspelled words, shown in a lightweight desktop GUI for quick inference.
            </p>
          ...
          <div className='relative'>
            <div className='rounded-ui border border-line/40 bg-surface/20 backdrop-blur-xl overflow-hidden shadow-2xl'>
              ...
              <div className='bg-[#111417] p-3'>
                <img src={spelling_img} alt='Spelling Correction AI GUI screenshot' className='w-full rounded-[10px] border border-line/20 object-cover shadow-xl' />
              </div>
            </div>
          </div>
        </div>
